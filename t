...
local function processListingInfo(uid, gems, item, version, shiny, amount, boughtFrom, boughtStatus, class, failMessage, snipeNormal)
    ...
    local message1 = {
		...
		["author"] = {
			["name"] = "Asatos sniper",
			["icon_url"] = "https://media.discordapp.net/attachments/786950908172435507/1092576851068715089/attachment-5.gif?ex=65a5b1fc&is=65933cfc&hm=a46449c064619a3a34503e69786bb6d356a689efe056f90b7c1bf2c9eda1508a&",
		},
                ['title'] = snipeMessage,
                ["color"] = webcolor,
